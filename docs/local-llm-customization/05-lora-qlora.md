...
助教業務では、次のような用途に向いています。

- レポート講評の形式を揃える
- 論文要約のフォーマットを固定する
- 学習者からの質問への回答スタイルを安定させる
- 研究メモを構造化JSONに変換する
- 自由記述アンケートを分類する
- 査読コメント風の観点出しを安定させる
...
```json
{
  "instruction": "以下の提出物に講評を書いてください。",
  "input": "実験目的は書けているが、考察が結果の繰り返しになっている...",
  "output": "良い点: 実験目的は明確に書けています。\n改善点: 考察では、結果から何が言えるかを一段深く説明しましょう。\n次回: 図表の観察事実と、自分の解釈を分けて書くと読みやすくなります。"
}
```
...
たとえば、授業資料の内容はRAGで参照し、回答の文体や形式はLoRAで安定させる、という組み合わせができます。
